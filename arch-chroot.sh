...
# Multimedia
pacman -S --noconfirm --needed ffmpeg mpv
...
# Hyprland
pacman -S --noconfirm --needed hyprland hyprcursor hypridle hyprlock hyprutils rofi-wayland jq mako grim slurp wl-clipboard libnotify nwg-look kitty polkit-gnome

# Gnome applications
pacman -S --noconfirm --needed gnome-characters gnome-disk-utility gnome-logs gnome-system-monitor gnome-text-editor gnome-themes-extra loupe dconf gsettings-desktop-schemas gsettings-system-schemas adwaita-icon-theme
...
# Software
pacman -S --noconfirm --needed cmus font-manager pinta qbittorrent yazi
